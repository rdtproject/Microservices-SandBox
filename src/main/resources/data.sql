...
insert into tour  (tour_package_code, title, description, blurb, bullets, DIFFICULTy, duration, price, region, keywords) values
  ...
  (
    ...
    'Cycle from Monterey to Santa Barbara, Bike 17 Mile Drive, Stop in at CENTRAL_COAST wineries, Spectacular views of the Pacific coastline, Accompanied by two companion cars',
   'MEDIUM',
    '6 days',
    '2500',
    'VARIES',
  ...
  (
    'TC',
    'Hot Salsa Tour',
    'Spice addict? SOUTHERN_CALIFORNIA is know for its heat! Try this three day tour of some of the hottest chilies, salsas, and picantes north of the Mexican border.',
